...
&{TOPNAV_PAGE_USER_MENU} =                   Menu1=Dashboard        Menu2=Settings          Menu3=Log Out
${TOPNAV_PAGE_CLICK_USER_ICON} =             xpath=//div[contains(@class, 'userPanel')]//div
...
Check if "User Menu" has all elements
    Click "User Menu"
    wait until page contains        ${TOPNAV_PAGE_USER_MENU.Menu1}
    wait until page contains        ${TOPNAV_PAGE_USER_MENU.Menu2}
    wait until page contains        ${TOPNAV_PAGE_USER_MENU.Menu3}

Click "User Menu"
    click element                   ${TOPNAV_PAGE_CLICK_USER_ICON}
