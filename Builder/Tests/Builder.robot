...
#CMD: robot -d Results Tests/Builder.robot
...
User should be able to "SignUp" to the web site using valis credentials
    [Documentation]    User should be able to sign up to the web site providing valid sign in info.
